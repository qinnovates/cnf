...
In the [ONI framework](https://github.com/qinnovates/qinnovate/blob/main/MAIN/publications/0-oni-framework/Blog-ONI_Framework.md), we call this the **liminal phase** — the state between states, where the system is neither here nor there. And it's governed by physics I'll return to shortly.
