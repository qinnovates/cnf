...
Use this template for all Medium-style posts in the ONI Framework series. This format is optimized for web readability and engagement.
...
[Opening hook - 1-3 sentences that grab attention. Use a bold statement, surprising fact, or thought-provoking question.]
...
- **Frequent headers:** Every 3-4 paragraphs
...
- "What if I told you..."
- "In [year], [something will happen]. Are we ready?"

### Length
- **Target:** 1,500-4,000 words (5-15 minute read)
- **Sweet spot:** 2,000-2,500 words

### Tags
Choose 5 tags that:
- Describe the main topic (e.g., `neuroscience`, `cybersecurity`)
- Capture the angle (e.g., `future`, `security`)
- Include relevant technology (e.g., `neuralink`, `ai`)
...
- [ ] Title is compelling (question or bold statement)
- [ ] Opening hook grabs attention in first 2 sentences
- [ ] Paragraphs are short (2-3 sentences)
- [ ] Headers break up content every 3-4 paragraphs
